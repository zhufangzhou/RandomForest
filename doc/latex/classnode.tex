...
\item 
float \hyperlink{classnode_a3c9943d5494f9418b72f2a212b06938c}{measure}
\item 
int \hyperlink{classnode_ae848f75fd8729aa74bd6718189387758}{n\+\_\+examples}
\item 
...
point to right node \hypertarget{classnode_a482f83436a89f09d289b26144d817adf}{\index{node@{node}!````~node@{$\sim$node}}
...
number of examples in this node \hypertarget{classnode_ad65aefa2c967c82cd88e6870085d7f3e}{\index{node@{node}!feature\+\_\+id@{feature\+\_\+id}}
...
number of different class in the node \hypertarget{classnode_a7cbff55ff448f557223f79299056e9b1}{\index{node@{node}!left@{left}}
...
-\/1 if this node is not leaf otherwise non-\/negtive integer \hypertarget{classnode_a3c9943d5494f9418b72f2a212b06938c}{\index{node@{node}!measure@{measure}}
\index{measure@{measure}!node@{node}}
\subsubsection[{measure}]{\setlength{\rightskip}{0pt plus 5cm}float node\+::measure}}\label{classnode_a3c9943d5494f9418b72f2a212b06938c}
for categorical attribute is the chosen feature value for left child node, for continous attribute is the threshold to determine left or right \hypertarget{classnode_a8c4864582cb3fe15e84e7908d0965150}{\index{node@{node}!n\+\_\+classes@{n\+\_\+classes}}
...
size should be {\ttfamily n\+\_\+classes}, means the weighted frequency for each class \hypertarget{classnode_ae848f75fd8729aa74bd6718189387758}{\index{node@{node}!n\+\_\+examples@{n\+\_\+examples}}
\index{n\+\_\+examples@{n\+\_\+examples}!node@{node}}
\subsubsection[{n\+\_\+examples}]{\setlength{\rightskip}{0pt plus 5cm}int node\+::n\+\_\+examples}}\label{classnode_ae848f75fd8729aa74bd6718189387758}
